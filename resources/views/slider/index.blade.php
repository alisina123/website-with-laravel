...
@section('content')
 ...
 <div class="col-md-12">
            ...
            <div class="card-tools">
                    <button class="btn btn-success" onclick="location.href='{{route('slider.create')}}'" >ADD <i class="fas fa-user-plus fa-fw"></i></button>
                </div>
                <div class="col-md-3">
                        ...
                        <tbody>
                            <tr v-for="(record,i) in apiData.data" :key="i">
                                ...
                                <td> 
                                    ...
                                    <button class="btn btn-info btn-xs" @click="editRecord('slider',record.id)"><i class="fa fa-pencil"></i>@lang('lang.edit')</button>
...
@push('scripts')
    ...
    methods:{
        ...
        imagePath(name=null)
        {
            ...
            if(name !=null)
            {
                var path="{{url('/')}}"+"/uploads/slider/"+name;
