...
@section('content')
    ...
    <div class="card card-primary" id="app" v-cloak>
      ...
      <!-- /.card-header -->
      <!-- form start -->
      <form role="form" id="form" method="POST"  @submit.prevent="onSubmit" action="/projects/store" accept-charset="utf-8" enctype="multipart/form-data" >
       @csrf
        <div class="card-body">
        <div class="row"> 
          <div class="col-5">
          ...
          onImageChange(e){
            ...
            onSubmit() {
               ...
               // console.log(this.form.title);
                ...
                axios.post('/projects/store', dataform).then( response => {
