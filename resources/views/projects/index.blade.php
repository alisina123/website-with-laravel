...
@section('content')
 ...
 <div class="col-md-12">
            ...
            <div class="card-tools">
                    <button class="btn btn-success" onclick="location.href='{{route('projects.create')}}'" >ADD <i class="fas fa-user-plus fa-fw"></i></button>
                </div>
                <div class="col-md-3">
                        ...
                        <tbody>
                            <tr v-for="(record,i) in apiData.data" :key="i">
                                ...
                                <td> 
                                    ...
                                    <button class="btn btn-info btn-xs" @click="editRecord('projects',record.id)"><i class="fa fa-pencil"></i>@lang('lang.edit')</button>
...
@push('scripts')
    ...
    methods:{
        ...
        imagePath(name=null)
        {
            ...
            if(name !=null)
            {
                var path="{{url('/')}}"+"/uploads/projects/"+name;
        ...
        editRecord(url=null,id=null)
        {
           // console.log(id);
            if(url !=null && id !=null)
            {   
                var url="{{url('/')}}"+"/"+url+"/projectsEdit/"+id;
                window.location=url;
            }
        }
    }
